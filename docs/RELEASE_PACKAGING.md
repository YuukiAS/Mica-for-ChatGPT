...
Chrome manifest 的机器版本与用户可见版本均使用 `scripts/release-config.mjs` 中的三段式正式 runtime 版本，例如 `0.1.4`。日常 runtime build 不再继续 `0.1.0-alpha.N` 双重编号。
